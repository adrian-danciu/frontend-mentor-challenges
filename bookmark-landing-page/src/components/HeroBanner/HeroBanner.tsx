  ...
  return (
    <div className="grid md:grid-cols-2 grid-cols-1 md:justify-between items-center ml-8 md:ml-[165px] md:mr-[103px] mr-10 mb-[140px]">
      ...
      <div className="relative order-1 md:order-2">
        <div className="absolute md:top-[50%] top-[45%] right-0 left-0 md:w-[120%] w-[80%] md:h-[85%] h-[300px] bg-[#5267DF] translate-x-1/3 -translate-y-1/4 rounded-l-full -z-10"></div>
